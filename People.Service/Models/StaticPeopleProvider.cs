    ...
    public class StaticPeopleProvider : IPeopleProvider
    {
        public List<Person> GetPeople()
        {
            var p = new List<Person>()
            {
                ...
                new Person() { Id=2, GivenName="Manu", FamilyName="Kanta",
                    StartDate = new DateTime(2000, 10, 2), Rating=8 },
                new Person() { Id=3, GivenName="Manasa", FamilyName="Kolla",
                ...
                new Person() { Id=5, GivenName="Sarath", FamilyName="Pool",
                    StartDate = new DateTime(1988, 2, 15), Rating=9 },
                new Person() { Id=6, GivenName="Dasha", FamilyName="Saru",
                ...
                new Person() { Id=8, GivenName="Tirupati", FamilyName="Loola",
                    StartDate = new DateTime(2000, 11, 1), Rating=5 },
                new Person() { Id=9, GivenName="Nayana", FamilyName="Malang",
